...
packages="../packages"
regular_packages=$(echo $(cat $packages|grep '#regular:'|sed 's/#.*$//g'|tr -d '\n'))
aur_packages=$(echo $(cat $packages|grep '#AUR:'|sed 's/#.*$//g'|tr -d '\n'))
forks=$(echo $(cat $packages|grep '#fork:'|sed 's/#.*$//g'|tr -d '\n'))
repositories=$(echo $(cat $packages|grep '#repo:'|sed 's/#.*$//g'|tr -d '\n'))
